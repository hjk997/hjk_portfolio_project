...
public class mybatisJavaConfigurationTest {
    ...
    void before() throws Exception {
        ...
        loginService = applicationContext.getBean("loginController", LoginService.class);
    }

    @Test
    public void 데이터베이스_연결_확인() throws Exception {
        AdminVO adminVO = new AdminVO(1, "hjk997", "345612", "hjk");
        Optional<AdminVO> resultAdminBean = loginService.login(adminVO);
